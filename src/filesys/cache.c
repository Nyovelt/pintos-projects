...
struct cache_entry {
	...
	block_sector_t sector; // the sector id of the block that currently occupies the cache entry.
...
static struct hash sector_cache_map; // a global mapping of sector numbers to cache entries
